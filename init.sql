...
CREATE TOPIC IF NOT EXISTS high_temperature_topic AS SELECT * FROM hourly_aggregation WHERE max_temperature > 30;

CREATE SUBSCRIPTION IF NOT EXISTS high_temp_alerts_mqtt ON high_temperature_topic USING MQTT ENDPOINT "tcp://mqtt-broker:1883" TOPIC "alerts/high_temperature";